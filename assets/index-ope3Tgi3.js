...
`)+`
`+p);const R=I+v+c,N=I+p+u,Q=ic(r,r.VERTEX_SHADER,R),F=ic(r,r.FRAGMENT_SHADER,N);r.attachShader(T,Q),r.attachShader(T,F),t.index0AttributeName!==void 0?r.bindAttribLocation(T,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(T,0,"position"),r.linkProgram(T);function l(D){if(i.debug.checkShaderErrors){const ae=r.getProgramInfoLog(T).trim(),W=r.getShaderInfoLog(Q).trim(),re=r.getShaderInfoLog(F).trim();let me=!0,te=!0;if(r.getProgramParameter(T,r.LINK_STATUS)===!1)if(me=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,T,Q,F);else{const de=rc(r,Q,"vertex"),ie=rc(r,F,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(T,r.VALIDATE_STATUS)+`
